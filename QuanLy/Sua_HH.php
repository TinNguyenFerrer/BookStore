...
<html>
    ...
    <body>
        <h1 style="text-align: center">Sửa Thông Tin Hàng Hóa</h1>
        <div class="login-form">
            <form name="Form_dang_ki" method="post" action="SuLy_Sua_HH.php?id_HH=<?php echo $id?>" enctype="multipart/form-data">
                <div class="input-box">
                    <label style="text-align: left; font-size: 130%;" for="TenHH">Tên <span style="color:red">*</span></label>
                    <br>
                    <input type="text" name="TenHH" id="TenHH" value="<?php echo $list_product['TenHH'];?>">
                </div>
                <div class="input-box">
                    <label style="text-align: left; font-size: 130%;" for="Gia">Giá <span style="color:red">*</span></label>
                    <br>
                    <input style=" width: 300px;" type="number" name="Gia" id="Gia" value="<?php echo $list_product['Gia'];?>">
                </div>
                <div class="input-box">
                    <label style="text-align: left; font-size: 130%;" for="SoLuong">Số Lượng <span style="color:red">*</span></label>
                    <br>
                    <input style=" width: 300px;" type="number" name="SoLuong" id="SoLuong" value="<?php echo $list_product['SoLuongHang'];?>">
                </div>
                <div>
                    <label style="text-align: left; font-size: 130%;" for="SoLuong">Hình <span style="color:red">*</span></label>
                    <br>
                    <img width="70px" class="img_product_mini" src="../KhachHang/Hinh/<?php echo $list_Hinh['TenHinh'];?>"></img>
                    <br>
